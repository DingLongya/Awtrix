$(function() {
    ...
    //Masked Input ============================================================================================================================
    var $demoMaskedInput = $('.advanced-masked-input');
    ...
    //IP Address
    $demoMaskedInput.find('.ip').inputmask('999.999.999.999', { placeholder: '_._._._' });
    ...
    try {
        //noUISlider
        var sliderBasic = document.getElementById('brightnessslider');
        ...
        getSliderValue(sliderBasic, true);
...
try {
    ...
    function getSliderValue(slider, percentage) {
